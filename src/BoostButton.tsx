...
const BoostButton = ({ content,difficulty, showDifficulty, onSending, onSuccess, onError }:BoostpowButtonOptions) => {
  ...
  return (
    <>
        ...
        >
            <div
                className={superBoost && !boostPopupOpen ? `absolute justify-center min-h-[42px] min-w-[42px] rounded-full border-t-4 border-green-500 animate-spin`: 'hidden'}
            />
            <div className={`hidden group-hover:block animate-ping absolute ${!showDifficulty ? "justify-center":"left-[18px]"} min-h-[33px] min-w-[33px] rounded-full bg-blue-200`}></div>
            <div className={`hidden group-hover:block animate-ping  delay-75 absolute ${!showDifficulty ? "justify-center":"left-[24px]"} min-h-[22px] min-w-[22px] rounded-full bg-blue-400`}></div>
            <div className={`hidden group-hover:block animate-ping  delay-100 absolute ${!showDifficulty ? "justify-center":"left-[29px]"} min-h-[11px] min-w-[11px] rounded-full bg-blue-600`}></div>
